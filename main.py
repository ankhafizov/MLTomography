...
if __name__ == "__main__":
    ...
    t = len(parameters.porosities) * len(parameters.sigmas)

    for phantom_porosity, phantom_sigma in tqdm(itertools.product(parameters.porosities, parameters.sigmas), total=t):
